  ...
  modules: [
       ...
       ============================================================ */
    {
      ...
      deliverables: [
        ...
        { name: 'Artifact 1 — TAM/SAM/SOM (PDF, 1 page)',               status: 'inprogress', notes: 'HTML built (PM_16_Artifact1_TAM_SAM_SOM.html). Print to PDF then add to ZIP.', file: 'PM_16_Artifact1_TAM_SAM_SOM.html' },
      ...
      level3Plan: [
        ...
        { step: 'Finalize Artifact 1 — TAM/SAM/SOM as 1-page PDF', why: 'HTML built; print to PDF from browser, add to ZIP.', done: null },
      ...
      checklist: [
        ...
        { label: 'Artifact 1 — TAM/SAM/SOM as 1-page PDF (print HTML → PDF)', done: null  },
