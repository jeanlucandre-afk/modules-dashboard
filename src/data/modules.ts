...
export const data: DashboardData = {
  ...
  todayFocus: [
    ...
    'PM_16 — Build TAM/SAM/SOM 1-page PDF (last artifact)',
  ...
  modules: [
       ...
       ============================================================ */
    {
      ...
      nextAction: 'Build the TAM/SAM/SOM 1-page PDF (only artifact left), then export main doc as PDF, ZIP + submit via Google Form',
      notes: 'All 21 questions done. All 4 Challenge reflections drafted and pasted into Google Docs (2026-05-02). 4 of 5 artifacts complete. Remaining: TAM/SAM/SOM artifact + PDF export + ZIP + submit.',
    },
