  ...
  modules: [
       ...
       ============================================================ */
    {
      ...
      deliverables: [
        ...
        { name: 'Challenge 1/4 — open template',                        status: 'todo',       notes: 'Template not yet filled. Open → complete → send Claude the brief + your answer.', url: 'https://docs.google.com/document/u/3/d/1CEcIveP8Fgdi_vZtzFc4z2Ynu7iRRpFtkiTbg7hfYPo/edit' },
        { name: 'Challenge 2/4 — open template',                        status: 'todo',       notes: 'Template not yet filled. Open → complete → send Claude the brief + your answer.', url: 'https://docs.google.com/document/u/3/d/1GX4Fpj0OFfxuF8TDhv8zqOO92-mNYBBYGGTOuPHY8f0/edit' },
        { name: 'Challenge 3/4 — open template',                        status: 'todo',       notes: 'Template not yet filled. Open → complete → send Claude the brief + your answer.', url: 'https://docs.google.com/document/u/3/d/1mGwLS4vzl2w4BBZ4Olw55MpZCsdi42pLSf7x1etBJh4/edit' },
        { name: 'Challenge 4/4 — open template',                        status: 'todo',       notes: 'Template not yet filled. Open → complete → send Claude the brief + your answer.', url: 'https://docs.google.com/document/u/3/d/1jMOZiVHKlARzH53_aEHIistWRRBuqJ2i43e4d4z45fs/edit' },
        { name: 'ZIP submission via Google Form',                       status: 'todo',       notes: 'Final step: Doc PDF + artifacts folder + Google Form' },
      ],
      level3Plan: [
        ...
        { step: 'Finalize Artifact 1 — TAM/SAM/SOM as 1-page PDF', why: '40 pts across 5 artifacts = 8 pts each. ONLY artifact still open.', done: false },
        ...
        { step: 'Write the 4 Challenge reflections (10 pts total)', why: 'Need the 4 challenge briefs from Jean-Luc to draft these', done: false },
      ...
      checklist: [
        ...
        { label: 'Artifact 1 — TAM/SAM/SOM as 1-page PDF',                 done: false },
        ...
        { label: 'Challenge 1/4 reflection',                               done: false },
        { label: 'Challenge 2/4 reflection',                               done: false },
        { label: 'Challenge 3/4 reflection',                               done: false },
        { label: 'Challenge 4/4 reflection',                               done: false },
        { label: 'Doc exported as PDF',                                    done: false },
        { label: 'All files zipped',                                       done: false },
        { label: 'Submitted via Google Form',                              done: false },
      ],
      nextAction: 'Build the TAM/SAM/SOM 1-page PDF (only artifact left) and send Claude the 4 challenge briefs so we can draft those reflections',
      notes: 'All 21 questions in the main doc are done (Part 4 finalised 2026-04-30 with humanise-text skill). 4 of 5 artifacts are complete. Just TAM/SAM/SOM + 4 Challenge reflections + ZIP/submit left.',
    },
