...
export const data: DashboardData = {
  ...
  modules: [
       ...
       ============================================================ */
    {
      ...
      level3Plan: [
        { step: 'Pick the area/topic/project for the posters', why: 'Everything else flows from this', done: true },
        { step: 'Research design strategy tools/methods + sources (APA 7th)', done: true },
        { step: 'Build Poster 1: framing + role of Design + tools (advantages/disadvantages/implications) + your usage', done: true },
        { step: 'Build Poster 2: creative outcomes + next steps + design outcomes/touchpoints', done: true },
      ...
      checklist: [
        ...
        { label: 'Poster 1: framing + contextual relevance',                  done: true },
        { label: 'Poster 1: role of Design in Industry',                      done: true },
        { label: 'Poster 1: design strategy tools (advantages/disadvantages)', done: true },
        { label: 'Poster 1: own utilization of tools',                        done: true },
        { label: 'Poster 2: creative outcomes',                                done: true },
        { label: 'Poster 2: project milestones (immediate/mid/long)',          done: true },
        { label: 'Poster 2: design outcomes / touchpoints',                    done: true },
        { label: 'Reflection: self-assessed Level 3 + reasoning',              done: true },
