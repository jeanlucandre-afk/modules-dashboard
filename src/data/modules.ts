  ...
  modules: [
       ...
       ============================================================ */
    {
      ...
      deliverables: [
        {
          ...
          subTodos: [
            { label: 'Q1 — Getting most out of LLMs (Still example)',          done: '2026-05-03' },
            { label: 'Q2 — LLM tools in product ops (Still example)',          done: '2026-05-03' },
            { label: 'Q3 — Data infrastructure components in Still',           done: '2026-05-03' },
            { label: 'Q4 — Data culture components in Still',                  done: '2026-05-03' },
            { label: 'Q5 — Approach to data ethics (Still specific)',          done: '2026-05-03' },
            { label: 'Q6 — Where genAI could add user value in Still',         done: '2026-05-03' },
            { label: 'Q7 — Ensuring ethical use of genAI',                     done: '2026-05-03' },
            { label: 'Q8 — Measuring success of AI-enabled features',          done: '2026-05-03' },
            { label: 'Reflections (cumulative 1,171 / 2,000 words)',           done: '2026-05-03' },
            { label: 'AI-use statement included',                              done: '2026-05-03' },
        ...
        },
        {
          ...
          subTodos: [
            { label: 'Pick the real Mango Lab use case (ad creative generation, Stage A)', done: '2026-05-03' },
            { label: 'Write the prompt with clear context, role, examples, output spec',   done: '2026-05-03' },
            { label: 'Run it against gpt-image-1 and gpt-image-2, verify both work',       done: '2026-05-03' },
            { label: 'Note the model + version + reproduction steps',                       done: '2026-05-03' },
            { label: 'Include in the Portfolio PDF + standalone .md file',                  done: '2026-05-03' },
          ],
        },
      ...
      level3Plan: [
        ...
        { step: 'Compile to single PDF, submit via Google Form', done: false },
      ],
      checklist: [
        { label: 'Q1: Getting most out of LLMs (with Still example)',         done: '2026-05-03' },
        { label: 'Q2: LLM tools in product ops (with Still example)',         done: '2026-05-03' },
        { label: 'Q3: Data infrastructure components in Still',               done: '2026-05-03' },
        { label: 'Q4: Data culture components in Still',                      done: '2026-05-03' },
        { label: 'Q5: Approach to data ethics',                               done: '2026-05-03' },
        { label: 'Q6: Where genAI could add user value in Still',             done: '2026-05-03' },
        { label: 'Q7: Ensuring ethical use of genAI',                         done: '2026-05-03' },
        { label: 'Q8: Measuring success of AI features',                      done: '2026-05-03' },
        { label: 'Detailed runnable prompt included + reproducible (verified)', done: '2026-05-03' },
        { label: 'Reflections per Q (cumulative 1,171 / 2,000 words)',         done: '2026-05-03' },
        { label: 'Reflection emphasises value creation potential + risks',     done: '2026-05-03' },
        { label: 'AI-use statement included',                                  done: '2026-05-03' },
        { label: 'Compiled to single PDF + submitted via Google Form',         done: null },
      ],
      nextAction: 'DOCUMENT DONE ✓ (2026-05-03) — Open PM_18_Portfolio.docx in Word, export to PDF (File → Export), submit via Google Form linked in the brief.',
