...
// Edit this file to update everything.
// =============================================================
...
export interface ModuleData {
  ...
  nextAction: string;
  notes: string;
  /** Hue used for the card accent gradient */
  accent: 'violet' | 'pink' | 'sky' | 'emerald' | 'amber' | 'rose' | 'indigo' | 'teal';
  /** Filename of the module brief PDF inside /deliverables/{id}/ — usually module_brief.pdf */
  briefFile?: string;
}
  ...
  modules: [
    {
      ...
      deliverables: [
        ...
        { name: 'Pitch Deck (Mango Lab)',                                status: 'done',     notes: 'Reusable for problem framing', file: '../shared/01_pitch_deck.pdf' },
        { name: 'Validation Plan v3',                                    status: 'done',     notes: 'Build-Measure-Learn cycle', file: '../shared/06_validation_plan_v3.pdf' },
        { name: 'Traction Test Cards',                                   status: 'done',     notes: '5 hypothesis cards', file: '../shared/07_traction_test_cards.html' },
      ],
      checklist: [
    ...
    },
    {
      ...
      deliverables: [
        { name: 'Campaign Plan (HTML)',                          status: 'done',       notes: '12 sections, KPIs, calendar, risks', file: '../shared/08_engine001_campaign_plan.html' },
        { name: 'Creative Brief — 5 creatives (HTML)',           status: 'done',       notes: '3 HUMAN_ + 2 TECHNICAL_ with copy + Nano Banana 2 prompts', file: '../shared/09_engine001_creative_brief.html' },
        { name: 'Executive Summary for Roland (HTML)',           status: 'done',       notes: '1-page brief asking for €400 ad budget', file: '../shared/10_engine001_roland_summary.html' },
    ...
    },
    {
      ...
      deliverables: [
        { name: 'Main doc (Q2–Q21, all parts) — export as PDF', status: 'inprogress', notes: 'Doc ~80% drafted; Part 4 Journey & Reflection (Q14–19) needs filling', file: 'PM_16_Part4_Drafts.md' },
        ...
        { name: 'Artifact 4 — Unit Economics (PDF, 1 page)',     status: 'inprogress', notes: 'still_unit_economics.xlsx exists; needs PDF export', file: '../shared/04_unit_economics.xlsx' },
        { name: 'Artifact 5 — Pitch Deck (PDF)',                  status: 'inprogress', notes: 'Mango Lab Pitch Deck.pdf exists', file: '../shared/01_pitch_deck.pdf' },
...
/* ============================================================================
   Helpers — derive status, progress, accent gradients
   ============================================================================ */
...
export function moduleProgress(m: ModuleData): { pct: number; doneCount: number; totalCount: number } {
  // Progress = done deliverables / total deliverables (excluding undecided)
