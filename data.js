  ...
  modules: [
    {
      ...
      checklist: [
        { label: "Problem statement",                        done: null },
        { label: "≥5 user interviews + transcripts",         done: null },
        { label: "Secondary research (users / market / competitors)", done: null },
        { label: "User group definition + quantification",   done: null },
        { label: "1–3 Personas",                             done: null },
        { label: "User journey map",                         done: null },
        { label: "Value Proposition Canvas",                 done: null },
        { label: "Competitor matrix",                        done: null },
        { label: "PESTLE analysis",                          done: null },
        { label: "TAM / SAM / SOM (top-down + bottom-up)",   done: null },
        { label: "Beachhead market definition",              done: null },
        { label: "Solution from creativity techniques",      done: null },
        { label: "Value proposition statement",              done: null },
        { label: "Solution evaluation (DUF V S + SWOT)",     done: null },
        { label: "Prototype description / visualization",    done: null },
        { label: "≥3 hypothesis cards",                      done: null },
        { label: "Experiment board",                         done: null },
        { label: "Prototype test methods + results",         done: null },
        { label: "MVP description + user story map",         done: null },
        { label: "Build-Measure-Learn cycle",                done: null },
        { label: "Level-2 extras (Lean Canvas / trends / S-I Board)", done: null },
        { label: "Level-3 add-on (essay / article / workshop)", done: null }
      ],
      nextAction: "Answer Claude's PM_22 discovery questions to surface existing Mango Lab work",
      notes: "Mango Lab is the project. Jean-Luc has done substantial work but needs to recall what."
    },
    {
      id: "pm23",
      code: "PM_23 / BM_23",
